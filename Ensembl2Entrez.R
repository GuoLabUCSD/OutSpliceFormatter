...
my_rsem_data_clean$ENTREZID <- mapIds(org.Hs.eg.db, keys=my_rsem_data_clean$gene_id, column="ENTREZID", keytype = "ENSEMBL", multiVals="first")

#my_rsem_data_clean$symbol <- mapIds(org.Hs.eg.db, keys=my_rsem_data_clean$gene_id, column="SYMBOL", keytype = "ENSEMBL", multiVals="first")
